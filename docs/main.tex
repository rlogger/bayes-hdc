...
Bayes-HDC is, to our knowledge, the first HDC library built on JAX, providing XLA compilation, TPU support, and a functional programming interface. Torchhd offers the broadest model coverage and a mature ecosystem; hdlib provides domain-specific models for bioinformatics and graph classification; PyBHV contributes a rich Boolean algebra with threshold logic and symbolic analysis. Bayes-HDC unifies ideas from all three, targeting the JAX ecosystem and XLA-optimized hardware.
